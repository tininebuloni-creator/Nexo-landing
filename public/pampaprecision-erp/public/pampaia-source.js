(function () {
  ...
  function mount() {
    ...
    const dashboard = document.querySelector('#mod-dashboard, #pampaia-dashboard-mount');
    if (!dashboard) return;
    ...
    const anchor = dashboard.querySelector('.dashboard-hero') || dashboard.firstElementChild;
