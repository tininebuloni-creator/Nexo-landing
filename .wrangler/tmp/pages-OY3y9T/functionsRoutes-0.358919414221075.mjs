...
import { onRequestGet as __api_auditoria_fiscal_js_onRequestGet } from "C:\\Users\\usuario\\Documents\\Proyectos\\Nexo-landing\\functions\\api\\auditoria-fiscal.js"
import { onRequestOptions as __api_auditoria_fiscal_js_onRequestOptions } from "C:\\Users\\usuario\\Documents\\Proyectos\\Nexo-landing\\functions\\api\\auditoria-fiscal.js"
import { onRequestPost as __api_auditoria_fiscal_js_onRequestPost } from "C:\\Users\\usuario\\Documents\\Proyectos\\Nexo-landing\\functions\\api\\auditoria-fiscal.js"
...
export const routes = [
    ...
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_auditoria_fiscal_js_onRequestGet],
    },
  {
      routePath: "/api/auditoria-fiscal",
      mountPath: "/api",
      method: "OPTIONS",
      middlewares: [],
      modules: [__api_auditoria_fiscal_js_onRequestOptions],
    },
  {
      routePath: "/api/auditoria-fiscal",
      mountPath: "/api",
      method: "POST",
      middlewares: [],
      modules: [__api_auditoria_fiscal_js_onRequestPost],
    },
  ]